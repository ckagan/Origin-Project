...
sample.names = 'sample_names_corrected.txt'
arraydata = 'C:/Users/Courtney/Dropbox/LCL-iPSC/Origin/YGilad-CK-Aug23-14-ProbeLevelData-NotNormalized-NoBGSubtracted-FinalReport.txt'
...
# set the stage
  ...
  #pdf("Origin pluritest_boxplot.pdf")
	...
	try(
        ...
        pdf("Origin pluritest_image03c.pdf")
        par(mar=c(12,4,4,2))
        par(xaxt='n')
